...
INSERT INTO BattingScorecard (match_id, player_id, team_id, batting_position, runs_scored, balls_faced, fours, sixes, is_out, out_type, bowler_id, fielder_id) VALUES
(1, 8, 1, 1, 67, 49, 8, 2, TRUE, 'caught', 52, 48), -- Venkatesh Iyer
(1, 1, 1, 2, 85, 51, 9, 4, FALSE, 'not_out', NULL, NULL), -- Shreyas Iyer
(1, 4, 1, 3, 45, 32, 4, 1, TRUE, 'run_out', NULL, 47), -- Nitish Rana
(1, 5, 1, 4, 23, 18, 2, 1, TRUE, 'bowled', 53, NULL), -- Rinku Singh
(1, 2, 1, 5, 15, 8, 1, 1, FALSE, 'not_out', NULL, NULL), -- Andre Russell
...
(1, 6, 1, 10, 5, 3, 1, 0, FALSE, 'not_out', NULL, NULL), -- Umesh Yadav
(1, 13, 1, 11, 0, 1, 0, 0, TRUE, 'bowled', 52, NULL), -- Harshit Rana
...
(1, 50, 4, 4, 35, 31, 3, 1, TRUE, 'run_out', NULL, 4), -- Rajat Patidar
...
(1, 56, 4, 11, 1, 1, 0, 0, FALSE, 'not_out', NULL, NULL), -- Mahipal Lomror

-- Match 2: MI vs CSK (2023) - CSK Batting (First Innings)
(2, 32, 3, 1, 92, 58, 7, 4, FALSE, 'not_out', NULL, NULL), -- Ruturaj Gaikwad
(2, 33, 3, 2, 38, 25, 5, 1, TRUE, 'caught', 23, 17), -- Devon Conway
(2, 35, 3, 3, 25, 18, 2, 1, TRUE, 'run_out', NULL, 19), -- Ravindra Jadeja
(2, 34, 3, 4, 15, 12, 1, 1, TRUE, 'bowled', 22, NULL), -- Shivam Dube
(2, 31, 3, 5, 18, 14, 2, 0, TRUE, 'caught', 25, 20), -- MS Dhoni
(2, 36, 3, 6, 8, 6, 1, 0, TRUE, 'lbw', 22, NULL), -- Moeen Ali
(2, 43, 3, 7, 5, 4, 1, 0, FALSE, 'not_out', NULL, NULL), -- Shardul Thakur
...
(2, 17, 2, 2, 23, 18, 2, 1, TRUE, 'stumped', 36, 31), -- Ishan Kishan
(2, 18, 2, 3, 31, 22, 4, 0, TRUE, 'lbw', 35, NULL), -- Suryakumar Yadav
(2, 19, 2, 4, 28, 25, 2, 1, TRUE, 'caught', 40, 33), -- Tilak Varma
(2, 26, 2, 5, 18, 14, 1, 1, TRUE, 'bowled', 35, NULL), -- Hardik Pandya
(2, 20, 2, 6, 15, 12, 1, 1, TRUE, 'run_out', NULL, 32), -- Tim David
(2, 27, 2, 7, 12, 8, 2, 0, TRUE, 'caught', 39, 34), -- Cameron Green
(2, 25, 2, 8, 8, 7, 1, 0, TRUE, 'lbw', 35, NULL), -- Krunal Pandya
(2, 22, 2, 9, 5, 4, 1, 0, FALSE, 'not_out', NULL, NULL), -- Jasprit Bumrah
(2, 23, 2, 10, 2, 3, 0, 0, TRUE, 'bowled', 40, NULL), -- Trent Boult
...
(7, 8, 1, 3, 25, 18, 3, 0, TRUE, 'run_out', NULL, 35), -- Venkatesh Iyer
(7, 1, 1, 4, 42, 31, 4, 1, TRUE, 'caught', 36, 41), -- Shreyas Iyer
(7, 5, 1, 5, 28, 16, 2, 2, FALSE, 'not_out', NULL, NULL), -- Rinku Singh
(7, 2, 1, 6, 15, 8, 1, 1, FALSE, 'not_out', NULL, NULL), -- Andre Russell
