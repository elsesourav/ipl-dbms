...
VALUES
   ...
   (
      ...
      12.3,
      'rain',
      'Heavy rain stopped play during MI chase',
      3.0,
      TRUE
   ),
   ...
   (
      ...
      15.2,
      'bad_light',
      'Poor light conditions, floodlights insufficient',
      1.0,
      FALSE
   ),
   ...
   (
      ...
      8.1,
      'crowd_disturbance',
      'Crowd unrest after controversial decision',
      0.0,
      FALSE
   ),
   ...
   (
      ...
      6.4,
      'technical',
      'Spidercam malfunction caused delay',
      0.0,
      FALSE
   );